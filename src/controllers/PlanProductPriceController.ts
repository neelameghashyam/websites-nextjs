...
import { PlanProductPriceService } from '../services/PlanProductPriceService';

export class PlanProductPriceController {
  private service = new PlanProductPriceService();
